...
public class PictureCapturingImpl extends PictureCapturingAbstract {

    private static final String TAG = PictureCapturingImpl.class.getSimpleName();
     ...
     */
    private PictureCapturingImpl(final Activity activity) {
        super(activity);
    }
     ...
     */
    public static PictureCapturingAbstract getInstance(final Activity activity) {
        return new PictureCapturingImpl(activity);
    }
    ...
    private void takePicture() throws CameraAccessException {
        ...
        captureBuilder.set(CaptureRequest.JPEG_ORIENTATION, getOrientation(characteristics));
    ...
    private void saveImageToDisk(final byte[] bytes) {
        ...
        final File file = new File(Environment.getExternalStorageDirectory() + "/Download/" + cameraId + "_pic.jpg");
